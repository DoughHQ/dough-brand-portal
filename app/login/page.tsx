...
export default function LoginPage() {
  ...
  const isApplyStep = step === 'search' || step === 'details' || step === 'booking'
      ...
      {isApplyStep ? (
        <ApplyBrandFlow
          ...
          styles={{
            ...
            primaryBtnStyle: authPrimaryBtnStyle,
          }}
        />
      ) : null}
      ...
      {step === 'login' && (
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <button onClick={handleLogin} disabled={loading} style={authPrimaryBtnStyle(loading)}>
        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <button
              ...
              disabled={loading}
              style={authPrimaryBtnStyle(loading)}
            >
